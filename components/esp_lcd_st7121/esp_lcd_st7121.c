...
{
    ESP_LOGI(TAG, "version: %d.%d.%d", ESP_LCD_ST7121_VER_MAJOR, ESP_LCD_ST7121_VER_MINOR, ESP_LCD_ST7121_VER_PATCH);
...
//  {cmd, { data }, data_size, delay_ms}
    ...
    {0xA3, (uint8_t []){0x80, 0x01, 0x8C, 0xFF, 0x45, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x46, 0x00, 0x00, 0x1E, 0x5C, 0x1E, 0x80, 0x10, 0x00, 0x05,
                        0x00, 0x00, 0x00, 0x00, 0x00, 0x46, 0x00, 0x00, 0x1E, 0x5C,
                        0x1E, 0x80, 0x10, 0xEF, 0x58, 0x00, 0x00, 0x00, 0xFF}, 39, 0},
    {0xA6, (uint8_t []){0x0A, 0x00, 0x24, 0x71, 0x36, 0x00, 0x00, 0x00, 0x68, 0x68,
                        ...
                        0x06, 0x00, 0x00, 0x00, 0x00}, 55, 0},
    {0xA7, (uint8_t []){0x1A, 0x1A, 0xC0, 0x64, 0x40, 0x04, 0x15, 0x40, 0x00, 0x40,
                        ...
                        0x00, 0x20, 0x00, 0x68, 0x68, 0x91, 0xFF, 0x08, 0x80, 0x79}, 60, 0},
    {0xAC, (uint8_t []){0x1D, 0x18, 0x19, 0x1D, 0x18, 0x19, 0x04, 0x1C, 0x1D, 0x08,
                        ...
                        0x1D, 0x1D, 0x1D, 0x1D}, 44, 0},
    {0xAD, (uint8_t []){0x0C, 0x40, 0x46, 0x00, 0x07, 0x4B, 0x4B, 0xFF, 0xFF, 0xF0,
                        0x40, 0x0E, 0x01, 0x07, 0x42, 0x42, 0xFF, 0xFF, 0x01, 0x00,
                        0x00, 0xFF, 0xFF, 0xFF, 0xFF}, 25, 0},
    {0xAE, (uint8_t []){0xF0, 0xFF, 0x03, 0xF0, 0xFF, 0x03, 0x00}, 7, 0},
    {0xB2, (uint8_t []){0x15, 0x19, 0x05, 0x23, 0x49, 0x2D, 0x03, 0x2E, 0x5C, 0xD2,
                        0xFF, 0x10, 0x60, 0xFD, 0x20, 0xC0, 0x00}, 17, 0},
    {0xE8, (uint8_t []){0x20, 0x60, 0x04, 0x8E, 0x8E, 0x3E, 0x04, 0xDC, 0xDC, 0x3E,
                        0x06, 0xFA, 0x26, 0x3E}, 14, 0},
    {0x75, (uint8_t []){0x03, 0x04}, 2, 0},
    {0xE7, (uint8_t []){0x4B, 0x00, 0x00, 0xBE, 0x4B, 0x8C, 0x20, 0x1A, 0xF0, 0x7D,
    ...
    {0xC8, (uint8_t []){0x00, 0x00, 0x04, 0x08, 0x10, 0x00, 0x1F, 0x01, 0x39, 0x3E,
                        0x00, 0x78, 0x06, 0xE2, 0x02, 0x11, 0x33, 0x01, 0x7A, 0x0D,
                        0x21, 0xC4, 0x0B, 0x19, 0x08, 0x32, 0xA0, 0x08, 0x1A, 0x0A,
                        0xF3, 0x7F, 0x0E, 0xC5, 0xE8, 0x03, 0xFF}, 37, 0},
    {0xC9, (uint8_t []){0x00, 0x00, 0x04, 0x08, 0x10, 0x00, 0x1F, 0x01, 0x39, 0x3E,
                        0x00, 0x78, 0x06, 0xE2, 0x02, 0x11, 0x33, 0x01, 0x7A, 0x0D,
                        0x21, 0xC4, 0x0B, 0x19, 0x08, 0x32, 0xA0, 0x08, 0x1A, 0x0A,
                        0xF3, 0x7F, 0x0E, 0xC5, 0xE8, 0x03, 0xFF}, 37, 0},
